                                                        ...
                                                        <div class="text"
                                                            ...
                                                            <div>
                                                                <p style="text-size-adjust: none; word-break: break-word; line-height: 1.2; font-size: 12px; margin: 0px;">
                                                                    <span style="">Copyright © YunMail 2021~2023</span>
                                                                </p></div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td align="left" style="font-size: 0px; padding: 20px;">
                                                        <div class="text"
                                                            ...
                                                            <div>
                                                                <p style="text-align: left; text-size-adjust: none; word-break: break-word; line-height: 1.6; font-size: 14px; margin: 0px;">
                                                                    <span style="font-size: 14px;">你好，尊敬的云寄用户！</span>
                                                                </p>
                                                                <p style="text-align: left; text-size-adjust: none; word-break: break-word; line-height: 1.6; font-size: 14px; margin: 0px;">
                                                                        <span style="font-size: 14px;">以下是您用于验证身份的验证码，请在<span
                                                                                    style="color: #ff0909;">2分钟内</span>输入并完成验证。如非本人操作，请忽略此邮件。</span>
                                                                </p></div>
                                                        </div>
                                                    </td>
                                                </tr>
                                        ...
                                        <td class="fullTd"
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                                ...
                                                <tr>
                                                    <td align="left" style="font-size: 0px; padding: 15px;">
                                                        <div class="text"
                                                             style="font-family: 微软雅黑, &quot;Microsoft YaHei&quot;; overflow-wrap: break-word; margin: 0px; text-align: left; line-height: 1.2; color: rgb(0, 148, 255); font-size: 12px; font-weight: normal;">
                                                            <div>
                                                                <div style=""><span
                                                                            style="color: #0094ff; font-size: 18px;">初柒云寄</span>
                                                                </div>
                                                                <div style=""><span
                                                                            style="color: #0094ff; font-size: 18px;"><br></span>
                                                                </div>
                                                                <div style=""><span
                                                                            style="color: #666666; font-size: 12px;">此信为系统邮件，请不要直接回复。</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
